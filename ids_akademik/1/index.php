...
<html>
 <head>
	...
	<!-- Icon -->
	<link rel="shortcut icon" type="image/icon" href="Assets/logosma.png">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>SMAN 1 Mojosari</b></center></h1>
					<center><img src="../Assets/logosma.png" width="225" height="225" /></center>
					<center><h2><b>Kelompok 11 Developer Copyright &copy;  <?php echo date ('Y') ?></b></h2></center>
					<center><h4><b>Made with <strong><i class="fa fa-code"></i></strong> and <i class="fa fa-heart"></i> by Kelompok 11 Surabaya, West Java Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
